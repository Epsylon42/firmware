...
static const uint16_t letterToSegmentMap[] = {
    ...
    0b10000000000000, // _
    0b00000000000100, // `
    0b11000111100010, // a (half-closed eye)
    0b11101100100010, // b (mostly closed eye)
    0b11000110100011, // c (look 1)
    0b11000111100011, // d (look transition)
    0b11000101100011, // e (look 2)
    0b00000000000000, // f
    0b00000000000000, // g
    0b00000000000000, // h
    0b00000000000000, // i
